...
function addVertical() {
    const img = document.createElement('img');
    img.src = './Imagenes/rayaVertical.png'; // URL de ejemplo, cambiar por la ruta de la imagen deseada
    img.classList.add('image_rayaVertical');
...
function addPunto() {
    const img = document.createElement('img');
    img.src = './Imagenes/Punto.png'; // URL de ejemplo, cambiar por la ruta de la imagen deseada
...
function addBarrDoble() {
    const img = document.createElement('img');
    img.src = './Imagenes/BarraDoble.png'; // URL de ejemplo, cambiar por la ruta de la imagen deseada
...
function addPuntoN() {
    const img = document.createElement('img');
    img.src = './Imagenes/PuntoNegro.png'; // URL de ejemplo, cambiar por la ruta de la imagen deseada
    img.classList.add('image_Punto');
...
function addBarrDobleN() {
    const img = document.createElement('img');
    img.src = './Imagenes/BarraDobleNegra.png'; // URL de ejemplo, cambiar por la ruta de la imagen deseada
    img.classList.add('image_BarraDoble');
...
function addParada2() {
    const img = document.createElement('img');
    img.src = './Imagenes/Parada2.png'; // URL de ejemplo, cambiar por la ruta de la imagen deseada
...
function addParada3() {
    const img = document.createElement('img');
    img.src = './Imagenes/Parada3.png'; // URL de ejemplo, cambiar por la ruta de la imagen deseada
...
function addParada4() {
    const img = document.createElement('img');
    img.src = './Imagenes/Parada4.png'; // URL de ejemplo, cambiar por la ruta de la imagen deseada
...
function addParada5() {
    const img = document.createElement('img');
    img.src = './Imagenes/Parada5.png'; // URL de ejemplo, cambiar por la ruta de la imagen deseada
...
function addLlamada() {
    const img = document.createElement('img');
    img.src = './Imagenes/llamada.png'; // URL de ejemplo, cambiar por la ruta de la imagen deseada
...
function addBis() {
    const img = document.createElement('img');
    img.src = './Imagenes/Bis.png'; // URL de ejemplo, cambiar por la ruta de la imagen deseada
